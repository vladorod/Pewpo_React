...
export default class Slider extends Component {
  ...
  render() {
     ...
     <div className="slider"></div>
       ...
       <h1 style={{color: this.state.color}}> {this.props.data.title}</h1>
       
       <h2 style={{color: this.state.color}} >{this.props.data.title2}</h2>
       
       <h4 className='reg' style={{ marginRight: "50px", color: this.state.color }}>{this.props.data.content}</h4>
